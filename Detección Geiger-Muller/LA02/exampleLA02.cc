/* 
 * exampleLA02.cc: Simulación de ejemplo en Geant4.
 * 
...
int main(int argc,char** argv)
{
  ...
  runManager->SetUserInitialization(new LA02DetectorConstruction());
  ...
  runManager->SetUserInitialization(new LA02ActionInitialization());
